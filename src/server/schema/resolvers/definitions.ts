...
> = {
    ...
    createLife?: Resolver<
        ...
        ParentType,
        ContextType,
        RequireFields<GraphQLMutationCreateLifeArgs, 'birthday' | 'description' | 'firstName' | 'hobbies' | 'lastName'>
    >;
...
> = {
    ...
    getLife?: Resolver<GraphQLResolversTypes['Life'], ParentType, ContextType, Partial<GraphQLQueryGetLifeArgs>>;
